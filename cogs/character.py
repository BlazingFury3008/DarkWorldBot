...
class CharacterCog(commands.Cog):
    ...
    # Share Character (WIP)
    # ---------------------------
    @character.command(name="share", description="Show one of your saved characters to others")
    @app_commands.describe(name="Pick the character to display")
    ...
    @share.autocomplete("name")
    async def share_autocomplete(self, interaction: discord.Interaction, current: str):
        return await self._character_name_autocomplete(interaction, current)
